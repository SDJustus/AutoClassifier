...
class Visualizer():
    ...
    def plot_current_errors(self, total_steps, errors):
        ...
        """
        self.writer.add_scalars("Loss", {"loss": errors}, global_step=total_steps)
        

    def plot_performance(self, epoch, performance, tag=None):
        """ Plot performance
    ...
    def plot_pr_curve(self, y_trues, y_preds, t, global_step=1, tag=None):    
        ...
        self.writer.add_pr_curve_raw(tag if tag else "Precision_recall_curve", true_positive_counts=tpc, false_positive_counts=fpc, true_negative_counts=tnc, false_negative_counts=fnc,
